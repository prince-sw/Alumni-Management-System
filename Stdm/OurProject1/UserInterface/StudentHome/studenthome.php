    ...
    <div class="nav">
        ...
        <ul class="nav-links">
            ...
            <div class="menu">
                ...
                <li class="check-event-std">Events</li>
                <div class="dropdown">
                    <li class="dropbtn">Dropdown</button>
                        <div class="dropdown-content">
                            <a id="update-info" href="updateStdInfo.php">Update Info</a>
